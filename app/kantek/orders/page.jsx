...
const Orders = () => {
    ...
    const [expandedOrders, setExpandedOrders] = useState(new Set()); // State untuk order yang diperluas
                                                            ...
                                                            <div className="flex gap-4">
                                                                ...
                                                                <div className="flex-1">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="inline-flex items-center px-3 py-1 rounded-md text-sm font-medium bg-emerald-50 text-emerald-700 hover:bg-emerald-100 transition-colors mb-3"
                                                                    >
                                                                    ...
                                                                    {/* Detail pesanan yang dapat diperluas */}
                                                                    {expandedOrders.has(order._id) ? (
                                                                        <div className="space-y-3 mb-4 p-4 bg-gray-50 rounded-lg">
                                                                            <h4 className="font-medium text-gray-900 mb-3">Detail Menu Pesanan:</h4>
                                                                            {order.items.map((item, idx) => (
                                                                                <div key={idx} className="flex items-center space-x-3 p-3 bg-white rounded-lg shadow-sm">
                                                                                    {/* Gambar produk */}
                                                                                    <div className="relative h-16 w-16 rounded-lg overflow-hidden border bg-gray-50 flex-shrink-0">
                                                                                        <Image
                                                                                            src={item.product?.image?.[0] || assets.box_icon}
                                                                                            alt={item.product?.name || "Produk"}
                                                                                            fill
                                                                                        ...
                                                                                        {item.product?.offerPrice && item.product.offerPrice < item.product.price ? (
                                                                                            <div className="space-y-1">
                                                                                                ...
                                                                                                <div className="font-medium text-emerald-600">
                                                                                                    {currency}{(item.product.offerPrice * item.quantity).toLocaleString()}
                                                                                                </div>
                                                                                            </div>
                                                                                        ) : (
                                                                                            <div className="font-medium text-gray-900">
                                                                                                {currency}{((item.product?.price || item.product?.offerPrice || 0) * item.quantity).toLocaleString()}
                                                                                            </div>
                                                                                        )}
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            {order.items.map((item, idx) => (
                                                                                <div key={idx} className="flex items-center justify-between text-sm">
                                                                                    ...
                                                                                    <span className="text-gray-600">
                                                                                        {currency}{((item.product?.offerPrice || item.product?.price || 0) * item.quantity).toLocaleString()}
                                                                                    </span>
                                                                                </div>
                                                                            ))}
                                                                        </div>
