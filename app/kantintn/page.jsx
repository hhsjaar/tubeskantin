    ...
    <div className="flex-1 min-h-screen flex flex-col justify-between bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#479C25]/90 to-[#3a7d1f]/80  py-8 px-6 md:px-10 text-white shadow-lg">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-blue-100">Isi informasi produk dengan lengkap untuk ditampilkan di menu Kantin Tata Niaga</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex-1 max-w-4xl mx-auto w-full px-6 md:px-10 py-8 space-y-8">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-2">
            {[...Array(4)].map((_, index) => (
              <label 
                key={index} 
                htmlFor={`image${index}`}
                className={`relative h-24 w-24 rounded-lg overflow-hidden border-2 ${files[index] ? 'border-blue-500' : 'border-dashed border-gray-300'} flex items-center justify-center bg-gray-50 hover:bg-gray-100 transition-all cursor-pointer`}
              >
                <input 
                  onChange={(e) => {
                ...
                {files[index] ? (
                  ...
                  <div className="text-center p-2">
                    ...
                    <span className="text-xs text-gray-500 mt-1 block">Tambah Foto</span>
                  </div>
                )}
              </label>
            ))}
          </div>
          <p className="text-sm text-gray-500">Upload hingga 4 foto produk (disarankan rasio 1:1)</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="product-description">
                Deskripsi Produk
              </label>
              <textarea
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="kantin">
                Kantin
              </label>
              <input
                type="text"
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="offer-price">
                Harga (Rp)
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  type="number"
                  placeholder="0"
                  className="w-full pl-12 pr-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none"
            ...
            <div className="space-y-1" hidden>
              <label className="block text-sm font-medium text-gray-700" htmlFor="portion-size">
                Ukuran Porsi
              </label>
              <input
                id="portion-size"
        ...
        {/* Informasi Nutrisi */}
        <div className="bg-white rounded-xl shadow-md p-6 space-y-6 relative">
          {isLoading && (
            <div className="absolute inset-0 bg-white/80 flex items-center justify-center rounded-xl z-10">
              <div className="flex flex-col items-center">
                ...
                <p className="mt-2 text-sm font-medium text-gray-700">Mengambil data nutrisi...</p>
              </div>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="calories">
                Kalori
              </label>
              <input
                id="calories"
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="total-fat">
                Total Lemak (g)
              </label>
              <input
                id="total-fat"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="sodium">
                Sodium (mg)
              </label>
              <input
                id="sodium"
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="total-carbohydrates">
                Total Karbohidrat (g)
              </label>
              <input
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="vitaminD">
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="calcium">
                Kalsium (mg)
              </label>
              <input
                id="calcium"
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="iron">
                Zat Besi (mg)
              </label>
              <input
                id="iron"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="potassium">
                Kalium (mg)
              </label>
              <input
                id="potassium"
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="vitaminA">
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="vitaminC">
                Vitamin C (mg)
              </label>
              <input
                id="vitaminC"
        ...
        <div className="bg-white rounded-xl shadow-md p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="karbonMakanan">
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="karbonPengolahan">
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-gray-700" htmlFor="karbonTransportasiLimbah">
        ...
        <div className="flex justify-end">
          <button 
            type="submit" 
            className="px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-medium rounded-lg hover:shadow-lg transition-all flex items-center space-x-2 disabled:opacity-70 disabled:cursor-not-allowed"
