...
const AddProduct = () => {
  ...
  const [kantin, setKantin] = useState('Kantin Sipil'); 
    ...
    <div className="flex-1 min-h-screen flex flex-col justify-between bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#479C25]/90 to-[#3a7d1f]/80  py-8 px-6 md:px-10 text-white shadow-lg">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-blue-100">Isi informasi produk dengan lengkap untuk ditampilkan di menu Kantin Sipil</p>
        </div>
      </div>
