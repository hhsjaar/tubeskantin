                ...
                <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                        <div className="px-5 lg:px-16 xl:px-20">
                            <div className="rounded-2xl overflow-hidden dark:bg-gray-800 bg-white shadow-lg mb-6 transition-all duration-300 hover:shadow-xl dark:shadow-gray-800/30">
                                <Image
