...
const SideBar = () => {
    ...
    const menuItems = [
        { name: 'Tambah Produk', path: '/kansip', icon: assets.add_icon },
        { name: 'Daftar Produk', path: '/kansip/product-list', icon: assets.product_list_icon },
        { name: 'Pesanan', path: '/kansip/orders', icon: assets.order_icon },
    ];
